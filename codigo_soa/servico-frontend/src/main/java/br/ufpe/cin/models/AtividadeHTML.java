...
public class AtividadeHTML {
    private String html = "<!DOCTYPE html>\n" +
            ...
            "\t<div id=atividades>%s\n" +
            "\t</div>\n" +
            "\t<a href=\"cadastroAtividade\">Cadastrar Professor</a>\n" +
            "\n" +
            "\n" +
            "    <!-- jQuery -->\n" +
    ...
    public String formatString(String atividade) {
        return String.format(html, atividade);
    }
}
